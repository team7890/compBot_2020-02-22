...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton buttonBox5 = new JoystickButton(buttonBox, 5);
    ...
    buttonBack.whileHeld(new RaiseIntake(objIntake));
    buttonStart.whileHeld(new LowerIntake(objIntake));
  }
